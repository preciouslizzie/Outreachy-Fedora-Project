...
I explicitly specified a Hugging Face model, but RamaLama kept defaulting to the Ollama registry. Even when I tried:
...
Since Hugging Face transport failed, I explored variation within Ollama.
